...
const { createProjectAction } = require('./core/command/create/index.js')
const { generateFileAction } = require('./core/command/generate/index.js')
const { snippetCopyAction } = require('./core/command/snippet/index.js')
...
program
  .command('snippet')
  .description('Quickly get vscode custom code snippets')
  .action(snippetCopyAction)
